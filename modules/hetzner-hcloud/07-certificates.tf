# https://github.com/peterpramb/terraform-hcloud-certificates/tree/main
...
locals {
  ...
  # Build a map of all provided certificate objects to be imported, indexed by certificate name:
  import_certs = {
  ...
  # Build a map of all provided certificate objects to be managed, indexed by certificate name:
  manage_certs = {
